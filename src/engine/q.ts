...
export const strmem = function(src)
{
...
export const atoi = function(str)
{
	if (str == null)
		return 0;
...
export const atof = function(str)
{
	if (str == null)
		return 0.0;
...
export const btoa = function(src)
{
...
export const isNaN = maybeNumber => {
	if (state.isNaN) {
