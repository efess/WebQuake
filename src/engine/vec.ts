...
export const anglemod = function(a)
{
	return (a % 360.0 + 360.0) % 360.0;
};

export const boxOnPlaneSide = function(emins, emaxs, p)
{
	if (p.type <= 2)
	{
...
export const angleVectors = function(angles, forward = null, right = null, up = null)
{
	var angle;
...
export const concatRotations = function(m1, m2)
{
	return [
		[
